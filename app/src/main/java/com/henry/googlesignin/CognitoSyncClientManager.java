...
public class CognitoSyncClientManager {
     ...
     */
//    private static final String AWS_ACCOUNT_ID = Constants.AWS_ACCOUNT_ID;
//    private static final String IDENTITY_POOL_ID = Constants.IDENTITY_POOL_ID;
     ...
     */
//    private static final String UNAUTH_ROLE_ARN = Constants.UNAUTH_ROLE_ARN;
//    private static final String AUTH_ROLE_ARN = Constants.AUTH_ROLE_ARN;
    ...
    public static void init(Context context) {
        provider = new CognitoCachingCredentialsProvider(context,
                Constants.AWS_ACCOUNT_ID, Constants.IDENTITY_POOL_ID, Constants.UNAUTH_ROLE_ARN, Constants.AUTH_ROLE_ARN,Regions.US_EAST_1);
